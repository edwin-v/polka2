...
public:
	...
	enum { ACC_ACTIVATE_PRI = CanvasView::ACC_END, ACC_ACTIVATE_SEC, 
	       ACC_MOD_ACT_FLIP, ACC_SELECT, ACC_SELECT_TILE, ACC_MOD_SELECT_TILE,
	       ACC_MOD_SELECT_SQUARE, ACC_SELECT_FLOAT, 
	       ACC_COLORPICK_FG, ACC_COLORPICK_BG, ACC_QUICKPICK_FG, ACC_QUICKPICK_BG, 
	       ACC_DRAW_FG, ACC_DRAW_BG, ACC_MOD_DRAW_COL,
